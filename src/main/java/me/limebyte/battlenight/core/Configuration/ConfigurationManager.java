...
public class ConfigurationManager {
    ...
    public static void initialize() {
    	...
    	main = 		new Configuration(plugin, "Config.yml",
    				"To change Classes edit the Classes.yml file."
    								);
    	classes = 	new Configuration(plugin, "Classes.yml",
    				""
    							   	);
    	tracks = 	new Configuration(plugin, "Tracks.dat",
    			 	"You may edit this but it is not recommended as it will be overridden when you update BattleNight."
    			                  	, "PluginData");
    	arenas = 	new Configuration(plugin, "Arenas.dat",
    				"DO NOT EDIT THIS FILE!", "PluginData");
    	players = 	new Configuration(plugin, "Players.dat",
